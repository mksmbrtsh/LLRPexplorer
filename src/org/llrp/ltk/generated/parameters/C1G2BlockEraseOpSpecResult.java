...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=113&view=fit">LLRP Specification Section 15.2.1.5.5.5</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=160&view=fit">LLRP Specification Section 16.3.1.5.5.5</a>}
...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=113&view=fit">LLRP Specification Section 15.2.1.5.5.5</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=160&view=fit">LLRP Specification Section 16.3.1.5.5.5</a>}
      ...
      .
 */
public class C1G2BlockEraseOpSpecResult extends TLVParameter
     ...
     */
    public C1G2BlockEraseOpSpecResult(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public C1G2BlockEraseOpSpecResult(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (result == null) {
            ...
            throw new MissingParameterException(
                " result not set  for Parameter of Type C1G2BlockEraseOpSpecResult");
        }
        ...
        if (opSpecID == null) {
            ...
            throw new MissingParameterException(
                " opSpecID not set  for Parameter of Type C1G2BlockEraseOpSpecResult");
        }
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary) {
        ...
        int fieldCount;
        Custom custom;
        result = new C1G2BlockEraseResultType(binary.subList(position,
                    C1G2BlockEraseResultType.length()));
        position += C1G2BlockEraseResultType.length();
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (temp != null) {
            result = new C1G2BlockEraseResultType(temp);
        }
        ...
        if (element.getChildren().size() > 0) {
            String message = "C1G2BlockEraseOpSpecResult has unknown element " +
    ...
    //setters
    /**
    * set result of type C1G2BlockEraseResultType .
    * @param  result to be set
    */
    public void setResult(final C1G2BlockEraseResultType result) {
        this.result = result;
    }
    ...
    */
    ...
    //getters
    /**
    * get result of type C1G2BlockEraseResultType.
    * @return  C1G2BlockEraseResultType
    */
    ...
    */
    public String toString() {
        String result = "C1G2BlockEraseOpSpecResult: ";
        result += ", result: ";
        result += result;
        result += ", opSpecID: ";
        result += opSpecID;
