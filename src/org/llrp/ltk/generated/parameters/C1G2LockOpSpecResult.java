...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=113&view=fit">LLRP Specification Section 15.2.1.5.5.4</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=160&view=fit">LLRP Specification Section 16.3.1.5.5.4</a>}
...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=113&view=fit">LLRP Specification Section 15.2.1.5.5.4</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=160&view=fit">LLRP Specification Section 16.3.1.5.5.4</a>}
      ...
      .
 */
public class C1G2LockOpSpecResult extends TLVParameter
    implements AccessCommandOpSpecResult {
    public static final SignedShort TYPENUM = new SignedShort(352);
    private static final Logger LOGGER = Logger.getLogger(C1G2LockOpSpecResult.class);
    protected C1G2LockResultType result;
     ...
     */
    public C1G2LockOpSpecResult(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public C1G2LockOpSpecResult(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (result == null) {
            ...
            throw new MissingParameterException(
                " result not set  for Parameter of Type C1G2LockOpSpecResult");
        }
        ...
        if (opSpecID == null) {
            ...
            throw new MissingParameterException(
                " opSpecID not set  for Parameter of Type C1G2LockOpSpecResult");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (temp != null) {
            result = new C1G2LockResultType(temp);
        }
        ...
        if (element.getChildren().size() > 0) {
            String message = "C1G2LockOpSpecResult has unknown element " +
    ...
    //setters
    /**
    * set result of type C1G2LockResultType .
    * @param  result to be set
    */
    public void setResult(final C1G2LockResultType result) {
        this.result = result;
    }
    ...
    */
    ...
    //getters
    /**
    * get result of type C1G2LockResultType.
    * @return  C1G2LockResultType
    */
    ...
    */
    public String toString() {
        String result = "C1G2LockOpSpecResult: ";
        result += ", result: ";
        result += result;
        result += ", opSpecID: ";
        result += opSpecID;
