...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=37&view=fit">LLRP Specification Section 7.1.3.1.1.1</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=131&view=fit">LLRP Specification Section 16.2.2.1</a>}
...
public class UTCTimestamp extends TLVParameter implements Timestamp {
    ...
    private static final Logger LOGGER = Logger.getLogger(UTCTimestamp.class);
     ...
     */
    public UTCTimestamp(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public UTCTimestamp(Element element) throws InvalidLLRPMessageException {
        decodeXML(element);
    }
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (microseconds == null) {
            ...
            throw new MissingParameterException(
                " microseconds not set  for Parameter of Type UTCTimestamp");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "UTCTimestamp has unknown element " +
