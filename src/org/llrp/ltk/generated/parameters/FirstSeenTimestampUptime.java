...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=84&view=fit">LLRP Specification Section 13.2.3.10</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=145&view=fit">LLRP Specification Section 16.2.7.3.10</a>}
...
public class FirstSeenTimestampUptime extends TVParameter {
     ...
     */
    public FirstSeenTimestampUptime(LLRPBitList list) {
        decodeBinary(list);
    }
    ...
    */
    public FirstSeenTimestampUptime(Element element)
    ...
    public LLRPBitList encodeBinarySpecific() {
        ...
        if (microseconds == null) {
            ...
            throw new MissingParameterException(
                " microseconds not set  for Parameter of Type FirstSeenTimestampUptime");
        }
    ...
    */
    public void decodeXML(Element element) throws InvalidLLRPMessageException {
        ...
        if (element.getChildren().size() > 0) {
            String message = "FirstSeenTimestampUptime has unknown element " +
    ...
    */
    public String toString() {
        String result = "FirstSeenTimestampUptime: ";
        result += ", microseconds: ";
        result += microseconds;
