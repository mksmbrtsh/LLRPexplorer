...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=77&view=fit">LLRP Specification Section 13.1.4</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=125&view=fit">LLRP Specification Section 16.1.32</a>}


 */
public class KEEPALIVE_ACK extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(72);
    private static final Logger LOGGER = Logger.getLogger(KEEPALIVE_ACK.class);
     ...
     */
    public KEEPALIVE_ACK(final LLRPBitList list)
     ...
     */
    public KEEPALIVE_ACK(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public KEEPALIVE_ACK(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("KEEPALIVE_ACK", ns);
            //	Element root = new Element("KEEPALIVE_ACK");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "KEEPALIVE_ACK has unknown element " +
