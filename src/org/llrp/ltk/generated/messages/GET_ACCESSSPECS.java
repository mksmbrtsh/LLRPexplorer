...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=63&view=fit">LLRP Specification Section 11.1.9</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=123&view=fit">LLRP Specification Section 16.1.25</a>}


 */
public class GET_ACCESSSPECS extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(44);
    private static final Logger LOGGER = Logger.getLogger(GET_ACCESSSPECS.class);
    public static final String RESPONSETYPE = "GET_ACCESSSPECS_RESPONSE";

    /**
     * empty constructor to create new message
     * with LLRP version set to 1.0 (0x1).
     */
    public GET_ACCESSSPECS() {
     ...
     */
    public GET_ACCESSSPECS(final LLRPBitList list)
     ...
     */
    public GET_ACCESSSPECS(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GET_ACCESSSPECS(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GET_ACCESSSPECS", ns);
            //	Element root = new Element("GET_ACCESSSPECS");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "GET_ACCESSSPECS has unknown element " +
