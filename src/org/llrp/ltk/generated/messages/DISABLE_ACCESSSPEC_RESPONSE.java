...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=63&view=fit">LLRP Specification Section 11.1.8</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=123&view=fit">LLRP Specification Section 16.1.24</a>}


 */
public class DISABLE_ACCESSSPEC_RESPONSE extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(53);
    private static final Logger LOGGER = Logger.getLogger(DISABLE_ACCESSSPEC_RESPONSE.class);
     ...
     */
    public DISABLE_ACCESSSPEC_RESPONSE() {
     ...
     */
    public DISABLE_ACCESSSPEC_RESPONSE(final LLRPBitList list)
     ...
     */
    public DISABLE_ACCESSSPEC_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DISABLE_ACCESSSPEC_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DISABLE_ACCESSSPEC_RESPONSE", ns);
            //	Element root = new Element("DISABLE_ACCESSSPEC_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "DISABLE_ACCESSSPEC_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter DISABLE_ACCESSSPEC_RESPONSE");
            } else {
                LOGGER.warn(
                    "DISABLE_ACCESSSPEC_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "DISABLE_ACCESSSPEC_RESPONSE has unknown element " +
