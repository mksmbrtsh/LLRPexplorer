...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=53&view=fit">LLRP Specification Section 10.1.8</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=119&view=fit">LLRP Specification Section 16.1.10</a>}


 */
public class STOP_ROSPEC_RESPONSE extends LLRPMessage {
     ...
     */
    public STOP_ROSPEC_RESPONSE(final LLRPBitList list)
     ...
     */
    public STOP_ROSPEC_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public STOP_ROSPEC_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            //	Element root = new Element("STOP_ROSPEC_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "STOP_ROSPEC_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter STOP_ROSPEC_RESPONSE");
            } else {
                LOGGER.warn(
                    "STOP_ROSPEC_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "STOP_ROSPEC_RESPONSE has unknown element " +
