...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=54&view=fit">LLRP Specification Section 10.1.10</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=120&view=fit">LLRP Specification Section 16.1.12</a>}


 */
public class ENABLE_ROSPEC_RESPONSE extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(34);
    private static final Logger LOGGER = Logger.getLogger(ENABLE_ROSPEC_RESPONSE.class);
     ...
     */
    public ENABLE_ROSPEC_RESPONSE(final LLRPBitList list)
     ...
     */
    public ENABLE_ROSPEC_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ENABLE_ROSPEC_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ENABLE_ROSPEC_RESPONSE", ns);
            //	Element root = new Element("ENABLE_ROSPEC_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "ENABLE_ROSPEC_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter ENABLE_ROSPEC_RESPONSE");
            } else {
                LOGGER.warn(
                    "ENABLE_ROSPEC_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "ENABLE_ROSPEC_RESPONSE has unknown element " +
