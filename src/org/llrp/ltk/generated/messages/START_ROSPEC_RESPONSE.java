...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=52&view=fit">LLRP Specification Section 10.1.6</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=119&view=fit">LLRP Specification Section 16.1.8</a>}


 */
public class START_ROSPEC_RESPONSE extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(32);
    private static final Logger LOGGER = Logger.getLogger(START_ROSPEC_RESPONSE.class);
     ...
     */
    public START_ROSPEC_RESPONSE(final LLRPBitList list)
     ...
     */
    public START_ROSPEC_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public START_ROSPEC_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("START_ROSPEC_RESPONSE", ns);
            //	Element root = new Element("START_ROSPEC_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "START_ROSPEC_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter START_ROSPEC_RESPONSE");
            } else {
                LOGGER.warn(
                    "START_ROSPEC_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "START_ROSPEC_RESPONSE has unknown element " +
