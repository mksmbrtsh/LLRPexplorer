...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=61&view=fit">LLRP Specification Section 11.1.3</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=122&view=fit">LLRP Specification Section 16.1.19</a>}
...
public class DELETE_ACCESSSPEC extends LLRPMessage {
     ...
     */
    public DELETE_ACCESSSPEC(final LLRPBitList list)
     ...
     */
    public DELETE_ACCESSSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DELETE_ACCESSSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type DELETE_ACCESSSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            //	Element root = new Element("DELETE_ACCESSSPEC");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DELETE_ACCESSSPEC has unknown element " +
