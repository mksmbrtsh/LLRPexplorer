...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=70&view=fit">LLRP Specification Section 12.1.4</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=128&view=fit">LLRP Specification Section 16.1.39</a>}


 */
public class SET_READER_CONFIG_RESPONSE extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(13);
    private static final Logger LOGGER = Logger.getLogger(SET_READER_CONFIG_RESPONSE.class);
     ...
     */
    public SET_READER_CONFIG_RESPONSE() {
     ...
     */
    public SET_READER_CONFIG_RESPONSE(final LLRPBitList list)
     ...
     */
    public SET_READER_CONFIG_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public SET_READER_CONFIG_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("SET_READER_CONFIG_RESPONSE", ns);
            //	Element root = new Element("SET_READER_CONFIG_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "SET_READER_CONFIG_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter SET_READER_CONFIG_RESPONSE");
            } else {
                LOGGER.warn(
                    "SET_READER_CONFIG_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "SET_READER_CONFIG_RESPONSE has unknown element " +
