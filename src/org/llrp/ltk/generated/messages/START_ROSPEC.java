...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=52&view=fit">LLRP Specification Section 10.1.5</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=118&view=fit">LLRP Specification Section 16.1.7</a>}


 */
public class START_ROSPEC extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(22);
    private static final Logger LOGGER = Logger.getLogger(START_ROSPEC.class);
    public static final String RESPONSETYPE = "START_ROSPEC_RESPONSE";
     ...
     */
    public START_ROSPEC(final LLRPBitList list)
     ...
     */
    public START_ROSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public START_ROSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (rOSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " rOSpecID not set  for Parameter of Type START_ROSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("START_ROSPEC", ns);
            //	Element root = new Element("START_ROSPEC");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "START_ROSPEC has unknown element " +
