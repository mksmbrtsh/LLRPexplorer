...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=54&view=fit">LLRP Specification Section 10.1.11</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=120&view=fit">LLRP Specification Section 16.1.13</a>}
...
public class DISABLE_ROSPEC extends LLRPMessage {
     ...
     */
    public DISABLE_ROSPEC(final LLRPBitList list)
     ...
     */
    public DISABLE_ROSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DISABLE_ROSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (rOSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " rOSpecID not set  for Parameter of Type DISABLE_ROSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DISABLE_ROSPEC", ns);
            //	Element root = new Element("DISABLE_ROSPEC");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "DISABLE_ROSPEC has unknown element " +
