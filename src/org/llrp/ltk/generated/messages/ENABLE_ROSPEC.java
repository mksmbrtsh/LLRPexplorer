...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=53&view=fit">LLRP Specification Section 10.1.9</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=119&view=fit">LLRP Specification Section 16.1.11</a>}


 */
public class ENABLE_ROSPEC extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(24);
    private static final Logger LOGGER = Logger.getLogger(ENABLE_ROSPEC.class);
     ...
     */
    public ENABLE_ROSPEC(final LLRPBitList list)
     ...
     */
    public ENABLE_ROSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ENABLE_ROSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (rOSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " rOSpecID not set  for Parameter of Type ENABLE_ROSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ENABLE_ROSPEC", ns);
            //	Element root = new Element("ENABLE_ROSPEC");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ENABLE_ROSPEC has unknown element " +
