...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=62&view=fit">LLRP Specification Section 11.1.7</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=123&view=fit">LLRP Specification Section 16.1.23</a>}


 */
public class DISABLE_ACCESSSPEC extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(43);
    private static final Logger LOGGER = Logger.getLogger(DISABLE_ACCESSSPEC.class);
    public static final String RESPONSETYPE = "DISABLE_ACCESSSPEC_RESPONSE";
     ...
     */
    public DISABLE_ACCESSSPEC(final LLRPBitList list)
     ...
     */
    public DISABLE_ACCESSSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public DISABLE_ACCESSSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type DISABLE_ACCESSSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("DISABLE_ACCESSSPEC", ns);
            //	Element root = new Element("DISABLE_ACCESSSPEC");
            ...
            if (accessSpecID == null) {
                ...
                root.addContent(accessSpecID.encodeXML("AccessSpecID", ns));
            }
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.warn(
                    "Element accessSpecID not provided in xml as child of " +
                    root.getName());
            ...
            if (root.getChildren().size() > 0) {
                String message = "DISABLE_ACCESSSPEC has unknown element " +
