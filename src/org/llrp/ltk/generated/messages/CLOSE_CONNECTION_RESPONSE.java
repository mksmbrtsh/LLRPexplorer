...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=71&view=fit">LLRP Specification Section 12.1.6</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=128&view=fit">LLRP Specification Section 16.1.41</a>}


 */
public class CLOSE_CONNECTION_RESPONSE extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(4);
    private static final Logger LOGGER = Logger.getLogger(CLOSE_CONNECTION_RESPONSE.class);
     ...
     */
    public CLOSE_CONNECTION_RESPONSE(final LLRPBitList list)
     ...
     */
    public CLOSE_CONNECTION_RESPONSE(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public CLOSE_CONNECTION_RESPONSE(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("CLOSE_CONNECTION_RESPONSE", ns);
            //	Element root = new Element("CLOSE_CONNECTION_RESPONSE");
    ...
    */
    protected void decodeBinarySpecific(LLRPBitList binary)
        ...
        try {
            ...
            LOGGER.warn(
                "CLOSE_CONNECTION_RESPONSE misses non optional parameter of type LLRPStatus");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (temp != null) {
                ...
                LOGGER.info(
                    "setting parameter lLRPStatus for parameter CLOSE_CONNECTION_RESPONSE");
            } else {
                LOGGER.warn(
                    "CLOSE_CONNECTION_RESPONSE misses non optional parameter of type lLRPStatus");
            ...
            if (root.getChildren().size() > 0) {
                String message = "CLOSE_CONNECTION_RESPONSE has unknown element " +
