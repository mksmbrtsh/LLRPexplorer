...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=78&view=fit">LLRP Specification Section 13.1.6</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=126&view=fit">LLRP Specification Section 16.1.34</a>}


 */
public class ENABLE_EVENTS_AND_REPORTS extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(64);
    private static final Logger LOGGER = Logger.getLogger(ENABLE_EVENTS_AND_REPORTS.class);
     ...
     */
    public ENABLE_EVENTS_AND_REPORTS() {
     ...
     */
    public ENABLE_EVENTS_AND_REPORTS(final LLRPBitList list)
     ...
     */
    public ENABLE_EVENTS_AND_REPORTS(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ENABLE_EVENTS_AND_REPORTS(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ENABLE_EVENTS_AND_REPORTS", ns);
            //	Element root = new Element("ENABLE_EVENTS_AND_REPORTS");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ENABLE_EVENTS_AND_REPORTS has unknown element " +
