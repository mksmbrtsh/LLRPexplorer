...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=62&view=fit">LLRP Specification Section 11.1.5</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=122&view=fit">LLRP Specification Section 16.1.21</a>}


 */
public class ENABLE_ACCESSSPEC extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(42);
    private static final Logger LOGGER = Logger.getLogger(ENABLE_ACCESSSPEC.class);
    public static final String RESPONSETYPE = "ENABLE_ACCESSSPEC_RESPONSE";
     ...
     */
    public ENABLE_ACCESSSPEC(final LLRPBitList list)
     ...
     */
    public ENABLE_ACCESSSPEC(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public ENABLE_ACCESSSPEC(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    protected LLRPBitList encodeBinarySpecific()
        ...
        if (accessSpecID == null) {
            ...
            throw new InvalidLLRPMessageException(
                " accessSpecID not set  for Parameter of Type ENABLE_ACCESSSPEC");
        }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("ENABLE_ACCESSSPEC", ns);
            //	Element root = new Element("ENABLE_ACCESSSPEC");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "ENABLE_ACCESSSPEC has unknown element " +
