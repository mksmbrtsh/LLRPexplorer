...
See also {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=54&view=fit">LLRP Specification Section 10.1.13</a>}
 and {@link <a href="http://www.epcglobalinc.org/standards/llrp/llrp_1_0_1-standard-20070813.pdf#page=120&view=fit">LLRP Specification Section 16.1.15</a>}


 */
public class GET_ROSPECS extends LLRPMessage {
    public static final SignedShort TYPENUM = new SignedShort(26);
    private static final Logger LOGGER = Logger.getLogger(GET_ROSPECS.class);
     ...
     */
    public GET_ROSPECS(final LLRPBitList list)
     ...
     */
    public GET_ROSPECS(final byte[] byteArray)
        throws InvalidLLRPMessageException {
    ...
    */
    public GET_ROSPECS(final Document document)
        throws InvalidLLRPMessageException {
        decodeXML(document);
    }
    ...
    */
    public Document encodeXML() throws InvalidLLRPMessageException {
        try {
            ...
            Element root = new Element("GET_ROSPECS", ns);
            //	Element root = new Element("GET_ROSPECS");
    ...
    public void decodeXML(final Document document)
        ...
        try {
            ...
            if (root.getChildren().size() > 0) {
                String message = "GET_ROSPECS has unknown element " +
