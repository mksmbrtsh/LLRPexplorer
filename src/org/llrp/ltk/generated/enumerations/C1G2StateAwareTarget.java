 ...
 */
public class C1G2StateAwareTarget extends UnsignedByte
    implements LLRPEnumeration {
    public static final int SL = 0;
    public static final int Inventoried_State_For_Session_S0 = 1;
    ...
    /**
     * Create new C1G2StateAwareTarget by passing integer value.
     *
     ...
     */
    public C1G2StateAwareTarget(int value) {
        super(value);
    ...
    /**
    * Create new C1G2StateAwareTarget by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2StateAwareTarget(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2StateAwareTarget by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2StateAwareTarget(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2StateAwareTarget(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Inventoried_State_For_Session_S0")) {
            return 1;
        }

        if (name.equalsIgnoreCase("Inventoried_State_For_Session_S1")) {
            return 2;
        }

        if (name.equalsIgnoreCase("Inventoried_State_For_Session_S2")) {
            return 3;
        }

        if (name.equalsIgnoreCase("Inventoried_State_For_Session_S3")) {
            return 4;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Inventoried_State_For_Session_S0")) {
            return true;
        }

        if (name.equals("Inventoried_State_For_Session_S1")) {
            return true;
        }

        if (name.equals("Inventoried_State_For_Session_S2")) {
            return true;
        }

        if (name.equals("Inventoried_State_For_Session_S3")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2StateAwareTarget must convert BigInteger " + value +
