...
public class AISpecEventType extends UnsignedByte implements LLRPEnumeration {
    ...
    /**
     * Create new AISpecEventType by passing integer value.
     *
     ...
     */
    public AISpecEventType(int value) {
        super(value);
    ...
    /**
    * Create new AISpecEventType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public AISpecEventType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new AISpecEventType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public AISpecEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AISpecEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("End_Of_AISpec")) {
            return 0;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AISpecEventType must convert BigInteger " + value +
