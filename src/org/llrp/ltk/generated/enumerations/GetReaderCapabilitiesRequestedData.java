 ...
 */
public class GetReaderCapabilitiesRequestedData extends UnsignedByte
    implements LLRPEnumeration {
    public static final int All = 0;
    public static final int General_Device_Capabilities = 1;
    ...
    /**
     * Create new GetReaderCapabilitiesRequestedData by passing integer value.
     *
     ...
     */
    public GetReaderCapabilitiesRequestedData(int value) {
        super(value);
    ...
    /**
    * Create new GetReaderCapabilitiesRequestedData by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public GetReaderCapabilitiesRequestedData(final Element element) {
        this(element.getText());
    }

    /**
    * Create new GetReaderCapabilitiesRequestedData by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public GetReaderCapabilitiesRequestedData(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public GetReaderCapabilitiesRequestedData(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("General_Device_Capabilities")) {
            return 1;
        }

        if (name.equalsIgnoreCase("LLRP_Capabilities")) {
            return 2;
        }

        if (name.equalsIgnoreCase("Regulatory_Capabilities")) {
            return 3;
        }

        if (name.equalsIgnoreCase("LLRP_Air_Protocol_Capabilities")) {
            return 4;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("General_Device_Capabilities")) {
            return true;
        }

        if (name.equals("LLRP_Capabilities")) {
            return true;
        }

        if (name.equals("Regulatory_Capabilities")) {
            return true;
        }

        if (name.equals("LLRP_Air_Protocol_Capabilities")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn(
            "GetReaderCapabilitiesRequestedData must convert BigInteger " +
