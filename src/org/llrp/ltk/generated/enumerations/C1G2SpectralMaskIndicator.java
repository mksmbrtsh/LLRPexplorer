 ...
 */
public class C1G2SpectralMaskIndicator extends UnsignedByte
    ...
    */
    public C1G2SpectralMaskIndicator(final Element element) {
    ...
    */
    public C1G2SpectralMaskIndicator(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2SpectralMaskIndicator(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2SpectralMaskIndicator must convert BigInteger " +
