 ...
 */
public class ROReportTriggerType extends UnsignedByte implements LLRPEnumeration {
    public static final int None = 0;
    public static final int Upon_N_Tags_Or_End_Of_AISpec = 1;
    public static final int Upon_N_Tags_Or_End_Of_ROSpec = 2;
    Logger logger = Logger.getLogger(ROReportTriggerType.class);

    public ROReportTriggerType() {
        super(0);
    }

    /**
     * Create new ROReportTriggerType by passing integer value.
     *
     ...
     */
    public ROReportTriggerType(int value) {
        super(value);
    ...
    /**
    * Create new ROReportTriggerType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public ROReportTriggerType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new ROReportTriggerType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public ROReportTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ROReportTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Upon_N_Tags_Or_End_Of_AISpec")) {
            return 1;
        }

        if (name.equalsIgnoreCase("Upon_N_Tags_Or_End_Of_ROSpec")) {
            return 2;
        }
    ...
    public final String getName(final int value) {
        ...
        if (1 == value) {
            return "Upon_N_Tags_Or_End_Of_AISpec";
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Upon_N_Tags_Or_End_Of_AISpec")) {
            return true;
        }

        if (name.equals("Upon_N_Tags_Or_End_Of_ROSpec")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ROReportTriggerType must convert BigInteger " + value +
