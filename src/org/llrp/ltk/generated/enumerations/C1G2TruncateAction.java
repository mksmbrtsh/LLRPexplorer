...
import org.llrp.ltk.types.TwoBitEnumeration;
import org.llrp.ltk.types.TwoBitEnumeration;
 ...
 */
public class C1G2TruncateAction extends TwoBitEnumeration
    implements LLRPEnumeration {
    public static final int Unspecified = 0;
    public static final int Do_Not_Truncate = 1;
    public static final int Truncate = 2;
    Logger logger = Logger.getLogger(C1G2TruncateAction.class);

    public C1G2TruncateAction() {
        super(0);
    }

    /**
     * Create new C1G2TruncateAction by passing integer value.
     *
     ...
     */
    public C1G2TruncateAction(int value) {
        super(value);
    ...
    /**
    * Create new C1G2TruncateAction by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2TruncateAction(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2TruncateAction by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2TruncateAction(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2TruncateAction(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Do_Not_Truncate")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Do_Not_Truncate")) {
            return true;
        }
    ...
    */
    public static int length() {
        return TwoBitEnumeration.length();
    }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2TruncateAction must convert BigInteger " + value +
