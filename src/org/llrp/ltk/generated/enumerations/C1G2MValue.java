 ...
 */
public class C1G2MValue extends UnsignedByte implements LLRPEnumeration {
    public static final int MV_FM0 = 0;
    ...
    /**
     * Create new C1G2MValue by passing integer value.
     *
    ...
    /**
    * Create new C1G2MValue by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2MValue(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2MValue by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2MValue(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2MValue(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("MV_FM0")) {
            return 0;
        }

        if (name.equalsIgnoreCase("MV_2")) {
            return 1;
        }

        if (name.equalsIgnoreCase("MV_4")) {
            return 2;
        }

        if (name.equalsIgnoreCase("MV_8")) {
            return 3;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2MValue must convert BigInteger " + value +
