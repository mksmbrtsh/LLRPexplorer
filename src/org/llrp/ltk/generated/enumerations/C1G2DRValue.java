 ...
 */
public class C1G2DRValue extends Bit implements LLRPEnumeration {
    public static final int DRV_8 = 0;
    public static final int DRV_64_3 = 1;
    Logger logger = Logger.getLogger(C1G2DRValue.class);
    ...
    /**
     * Create new C1G2DRValue by passing integer value.
     *
    ...
    /**
    * Create new C1G2DRValue by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2DRValue(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2DRValue by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2DRValue(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2DRValue(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("DRV_8")) {
            return 0;
        }

        if (name.equalsIgnoreCase("DRV_64_3")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("DRV_8")) {
            return true;
        }

        if (name.equals("DRV_64_3")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2DRValue must convert BigInteger " + value +
