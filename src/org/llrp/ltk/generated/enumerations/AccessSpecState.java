 ...
 */
public class AccessSpecState extends Bit implements LLRPEnumeration {
    ...
    /**
     * Create new AccessSpecState by passing integer value.
     *
    ...
    /**
    * Create new AccessSpecState by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public AccessSpecState(final Element element) {
        this(element.getText());
    }

    /**
    * Create new AccessSpecState by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public AccessSpecState(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AccessSpecState(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AccessSpecState must convert BigInteger " + value +
