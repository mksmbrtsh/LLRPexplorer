 ...
 */
public class AntennaEventType extends UnsignedByte implements LLRPEnumeration {
    ...
    /**
     * Create new AntennaEventType by passing integer value.
     *
     ...
     */
    public AntennaEventType(int value) {
        super(value);
    ...
    /**
    * Create new AntennaEventType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public AntennaEventType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new AntennaEventType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public AntennaEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AntennaEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Antenna_Disconnected")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Antenna_Connected")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Antenna_Disconnected")) {
            return true;
        }

        if (name.equals("Antenna_Connected")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AntennaEventType must convert BigInteger " + value +
