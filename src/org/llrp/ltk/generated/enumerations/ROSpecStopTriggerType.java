 ...
 */
public class ROSpecStopTriggerType extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Null = 0;
    public static final int Duration = 1;
    public static final int GPI_With_Timeout = 2;
    Logger logger = Logger.getLogger(ROSpecStopTriggerType.class);

    public ROSpecStopTriggerType() {
        super(0);
    }

    /**
     * Create new ROSpecStopTriggerType by passing integer value.
     *
     ...
     */
    public ROSpecStopTriggerType(int value) {
        super(value);
    ...
    /**
    * Create new ROSpecStopTriggerType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public ROSpecStopTriggerType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new ROSpecStopTriggerType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public ROSpecStopTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ROSpecStopTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("GPI_With_Timeout")) {
            return 2;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("GPI_With_Timeout")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ROSpecStopTriggerType must convert BigInteger " + value +
