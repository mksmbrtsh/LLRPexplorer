 ...
 */
public class GPIPortState extends UnsignedByte implements LLRPEnumeration {
    public static final int Low = 0;
    public static final int High = 1;
    public static final int Unknown = 2;
    Logger logger = Logger.getLogger(GPIPortState.class);
    ...
    /**
     * Create new GPIPortState by passing integer value.
     *
    ...
    /**
    * Create new GPIPortState by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public GPIPortState(final Element element) {
        this(element.getText());
    }

    /**
    * Create new GPIPortState by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public GPIPortState(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public GPIPortState(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("GPIPortState must convert BigInteger " + value +
