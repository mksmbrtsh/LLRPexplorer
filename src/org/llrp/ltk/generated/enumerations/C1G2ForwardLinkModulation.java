 ...
 */
public class C1G2ForwardLinkModulation extends UnsignedByte
    implements LLRPEnumeration {
    public static final int PR_ASK = 0;
    public static final int SSB_ASK = 1;
    public static final int DSB_ASK = 2;
    Logger logger = Logger.getLogger(C1G2ForwardLinkModulation.class);

    public C1G2ForwardLinkModulation() {
        super(0);
    }

    /**
     * Create new C1G2ForwardLinkModulation by passing integer value.
     *
     ...
     */
    public C1G2ForwardLinkModulation(int value) {
        super(value);
    ...
    /**
    * Create new C1G2ForwardLinkModulation by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2ForwardLinkModulation(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2ForwardLinkModulation by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2ForwardLinkModulation(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2ForwardLinkModulation(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("PR_ASK")) {
            return 0;
        }

        if (name.equalsIgnoreCase("SSB_ASK")) {
            return 1;
        }

        if (name.equalsIgnoreCase("DSB_ASK")) {
            return 2;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("PR_ASK")) {
            return true;
        }

        if (name.equals("SSB_ASK")) {
            return true;
        }

        if (name.equals("DSB_ASK")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2ForwardLinkModulation must convert BigInteger " +
