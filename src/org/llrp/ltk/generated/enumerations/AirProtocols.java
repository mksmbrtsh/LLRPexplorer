 ...
 */
public class AirProtocols extends UnsignedByte implements LLRPEnumeration {
    public static final int Unspecified = 0;
    public static final int EPCGlobalClass1Gen2 = 1;
    Logger logger = Logger.getLogger(AirProtocols.class);
    ...
    /**
     * Create new AirProtocols by passing integer value.
     *
    ...
    /**
    * Create new AirProtocols by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public AirProtocols(final Element element) {
        this(element.getText());
    }

    /**
    * Create new AirProtocols by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public AirProtocols(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AirProtocols(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AirProtocols must convert BigInteger " + value +
