...
public class RFSurveyEventType extends UnsignedByte implements LLRPEnumeration {
    ...
    Logger logger = Logger.getLogger(RFSurveyEventType.class);
    ...
    /**
     * Create new RFSurveyEventType by passing integer value.
     *
     ...
     */
    public RFSurveyEventType(int value) {
        super(value);
    ...
    /**
    * Create new RFSurveyEventType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public RFSurveyEventType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new RFSurveyEventType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public RFSurveyEventType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public RFSurveyEventType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Start_Of_RFSurvey")) {
            return 0;
        }

        if (name.equalsIgnoreCase("End_Of_RFSurvey")) {
            return 1;
        }
    ...
    public final String getName(final int value) {
        if (0 == value) {
            return "Start_Of_RFSurvey";
        }

        if (1 == value) {
            return "End_Of_RFSurvey";
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Start_Of_RFSurvey")) {
            return true;
        }

        if (name.equals("End_Of_RFSurvey")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("RFSurveyEventType must convert BigInteger " + value +
