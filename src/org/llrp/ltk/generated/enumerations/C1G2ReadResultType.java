...
public class C1G2ReadResultType extends UnsignedByte implements LLRPEnumeration {
    ...
    /**
     * Create new C1G2ReadResultType by passing integer value.
     *
     ...
     */
    public C1G2ReadResultType(int value) {
        super(value);
    ...
    /**
    * Create new C1G2ReadResultType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2ReadResultType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2ReadResultType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2ReadResultType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2ReadResultType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2ReadResultType must convert BigInteger " + value +
