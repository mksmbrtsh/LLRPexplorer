 ...
 */
public class C1G2LockResultType extends UnsignedByte implements LLRPEnumeration {
    ...
    Logger logger = Logger.getLogger(C1G2LockResultType.class);

    public C1G2LockResultType() {
        super(0);
    }

    /**
     * Create new C1G2LockResultType by passing integer value.
     *
     ...
     */
    public C1G2LockResultType(int value) {
        super(value);
    ...
    /**
    * Create new C1G2LockResultType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2LockResultType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2LockResultType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2LockResultType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2LockResultType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2LockResultType must convert BigInteger " + value +
