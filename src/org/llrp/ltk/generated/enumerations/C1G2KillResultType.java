 ...
 */
public class C1G2KillResultType extends UnsignedByte implements LLRPEnumeration {
    public static final int Success = 0;
    public static final int Zero_Kill_Password_Error = 1;
    public static final int Insufficient_Power = 2;
    public static final int Nonspecific_Tag_Error = 3;
    public static final int No_Response_From_Tag = 4;
    public static final int Nonspecific_Reader_Error = 5;
    Logger logger = Logger.getLogger(C1G2KillResultType.class);

    public C1G2KillResultType() {
        super(0);
    }

    /**
     * Create new C1G2KillResultType by passing integer value.
     *
     ...
     */
    public C1G2KillResultType(int value) {
        super(value);
    ...
    /**
    * Create new C1G2KillResultType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2KillResultType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2KillResultType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2KillResultType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2KillResultType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Zero_Kill_Password_Error")) {
            return 1;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Zero_Kill_Password_Error")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2KillResultType must convert BigInteger " + value +
