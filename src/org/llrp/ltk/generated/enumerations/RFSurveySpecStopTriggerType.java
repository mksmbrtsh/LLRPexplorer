 ...
 */
public class RFSurveySpecStopTriggerType extends UnsignedByte
    ...
    /**
     * Create new RFSurveySpecStopTriggerType by passing integer value.
     *
     ...
     */
    public RFSurveySpecStopTriggerType(int value) {
        super(value);
    ...
    /**
    * Create new RFSurveySpecStopTriggerType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public RFSurveySpecStopTriggerType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new RFSurveySpecStopTriggerType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public RFSurveySpecStopTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public RFSurveySpecStopTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("N_Iterations_Through_Frequency_Range")) {
            return 2;
        }
    ...
    public final String getName(final int value) {
        ...
        if (2 == value) {
            return "N_Iterations_Through_Frequency_Range";
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("N_Iterations_Through_Frequency_Range")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("RFSurveySpecStopTriggerType must convert BigInteger " +
