 ...
 */
public class ROSpecState extends UnsignedByte implements LLRPEnumeration {
    ...
    /**
     * Create new ROSpecState by passing integer value.
     *
    ...
    /**
    * Create new ROSpecState by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public ROSpecState(final Element element) {
        this(element.getText());
    }

    /**
    * Create new ROSpecState by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public ROSpecState(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ROSpecState(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ROSpecState must convert BigInteger " + value +
