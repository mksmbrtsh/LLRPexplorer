 ...
 */
public class C1G2StateUnawareAction extends UnsignedByte
    implements LLRPEnumeration {
    public static final int Select_Unselect = 0;
    public static final int Select_DoNothing = 1;
    public static final int DoNothing_Unselect = 2;
    ...
    /**
     * Create new C1G2StateUnawareAction by passing integer value.
     *
     ...
     */
    public C1G2StateUnawareAction(int value) {
        super(value);
    ...
    /**
    * Create new C1G2StateUnawareAction by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2StateUnawareAction(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2StateUnawareAction by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2StateUnawareAction(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2StateUnawareAction(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("Select_Unselect")) {
            return 0;
        }

        if (name.equalsIgnoreCase("Select_DoNothing")) {
            return 1;
        }

        if (name.equalsIgnoreCase("DoNothing_Unselect")) {
            return 2;
        }

        if (name.equalsIgnoreCase("Unselect_DoNothing")) {
            return 3;
        }

        if (name.equalsIgnoreCase("Unselect_Select")) {
            return 4;
        }

        if (name.equalsIgnoreCase("DoNothing_Select")) {
            return 5;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("Select_Unselect")) {
            return true;
        }

        if (name.equals("Select_DoNothing")) {
            return true;
        }

        if (name.equals("DoNothing_Unselect")) {
            return true;
        }

        if (name.equals("Unselect_DoNothing")) {
            return true;
        }

        if (name.equals("Unselect_Select")) {
            return true;
        }

        if (name.equals("DoNothing_Select")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2StateUnawareAction must convert BigInteger " + value +
