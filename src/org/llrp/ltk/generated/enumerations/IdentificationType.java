 ...
 */
public class IdentificationType extends UnsignedByte implements LLRPEnumeration {
    ...
    /**
     * Create new IdentificationType by passing integer value.
     *
     ...
     */
    public IdentificationType(int value) {
        super(value);
    ...
    /**
    * Create new IdentificationType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public IdentificationType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new IdentificationType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public IdentificationType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public IdentificationType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("MAC_Address")) {
            return 0;
        }

        if (name.equalsIgnoreCase("EPC")) {
            return 1;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("IdentificationType must convert BigInteger " + value +
