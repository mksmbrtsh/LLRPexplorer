 ...
 */
public class ROSpecStartTriggerType extends UnsignedByte
    ...
    */
    public ROSpecStartTriggerType(final Element element) {
    ...
    */
    public ROSpecStartTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ROSpecStartTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Immediate")) {
            return 1;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ROSpecStartTriggerType must convert BigInteger " + value +
