 ...
 */
public class KeepaliveTriggerType extends UnsignedByte
    ...
    /**
     * Create new KeepaliveTriggerType by passing integer value.
     *
     ...
     */
    public KeepaliveTriggerType(int value) {
        super(value);
    ...
    /**
    * Create new KeepaliveTriggerType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public KeepaliveTriggerType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new KeepaliveTriggerType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public KeepaliveTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public KeepaliveTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("KeepaliveTriggerType must convert BigInteger " + value +
