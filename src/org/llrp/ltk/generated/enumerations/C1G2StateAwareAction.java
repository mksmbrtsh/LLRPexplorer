 ...
 */
public class C1G2StateAwareAction extends UnsignedByte
    ...
    /**
     * Create new C1G2StateAwareAction by passing integer value.
     *
     ...
     */
    public C1G2StateAwareAction(int value) {
        super(value);
    ...
    /**
    * Create new C1G2StateAwareAction by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public C1G2StateAwareAction(final Element element) {
        this(element.getText());
    }

    /**
    * Create new C1G2StateAwareAction by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public C1G2StateAwareAction(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public C1G2StateAwareAction(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        if (name.equalsIgnoreCase("AssertSLOrA_DeassertSLOrB")) {
            return 0;
        }

        if (name.equalsIgnoreCase("AssertSLOrA_Noop")) {
            return 1;
        }

        if (name.equalsIgnoreCase("Noop_DeassertSLOrB")) {
            return 2;
        }

        if (name.equalsIgnoreCase("NegateSLOrABBA_Noop")) {
            return 3;
        }

        if (name.equalsIgnoreCase("DeassertSLOrB_AssertSLOrA")) {
            return 4;
        }

        if (name.equalsIgnoreCase("DeassertSLOrB_Noop")) {
            return 5;
        }

        if (name.equalsIgnoreCase("Noop_AssertSLOrA")) {
            return 6;
        }

        if (name.equalsIgnoreCase("Noop_NegateSLOrABBA")) {
            return 7;
        }
    ...
    public boolean isValidName(final String name) {
        if (name.equals("AssertSLOrA_DeassertSLOrB")) {
            return true;
        }

        if (name.equals("AssertSLOrA_Noop")) {
            return true;
        }

        if (name.equals("Noop_DeassertSLOrB")) {
            return true;
        }

        if (name.equals("NegateSLOrABBA_Noop")) {
            return true;
        }

        if (name.equals("DeassertSLOrB_AssertSLOrA")) {
            return true;
        }

        if (name.equals("DeassertSLOrB_Noop")) {
            return true;
        }

        if (name.equals("Noop_AssertSLOrA")) {
            return true;
        }

        if (name.equals("Noop_NegateSLOrABBA")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("C1G2StateAwareAction must convert BigInteger " + value +
