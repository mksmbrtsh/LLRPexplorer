 ...
 */
public class ConnectionAttemptStatusType extends UnsignedShort
    implements LLRPEnumeration {
    public static final int Success = 0;
    public static final int Failed_A_Reader_Initiated_Connection_Already_Exists = 1;
    public static final int Failed_A_Client_Initiated_Connection_Already_Exists = 2;
    ...
    */
    public ConnectionAttemptStatusType(final Element element) {
    ...
    */
    public ConnectionAttemptStatusType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public ConnectionAttemptStatusType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Another_Connection_Attempted")) {
            return 4;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Failed_A_Reader_Initiated_Connection_Already_Exists")) {
            return true;
        }

        if (name.equals("Failed_A_Client_Initiated_Connection_Already_Exists")) {
            return true;
        }

        if (name.equals("Failed_Reason_Other_Than_A_Connection_Already_Exists")) {
            return true;
        }

        if (name.equals("Another_Connection_Attempted")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("ConnectionAttemptStatusType must convert BigInteger " +
