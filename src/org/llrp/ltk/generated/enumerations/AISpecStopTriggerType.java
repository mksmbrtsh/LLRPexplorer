 ...
 */
public class AISpecStopTriggerType extends UnsignedByte
    ...
    /**
     * Create new AISpecStopTriggerType by passing integer value.
     *
     ...
     */
    public AISpecStopTriggerType(int value) {
        super(value);
    ...
    /**
    * Create new AISpecStopTriggerType by passing jdom element.
    *
    * @throws IllegalArgumentException
    ...
    */
    public AISpecStopTriggerType(final Element element) {
        this(element.getText());
    }

    /**
    * Create new AISpecStopTriggerType by passing a string.
    *
    * @throws IllegalArgumentException
    * if the string does not stand for a valid value.
    */
    public AISpecStopTriggerType(final String name) {
        if (!isValidName(name)) {
     ...
     */
    public AISpecStopTriggerType(final LLRPBitList list) {
        decodeBinary(list);
    ...
    */
    ...
    public final int getValue(final String name) {
        ...
        if (name.equalsIgnoreCase("Tag_Observation")) {
            return 3;
        }
    ...
    public boolean isValidName(final String name) {
        ...
        if (name.equals("Tag_Observation")) {
            return true;
        }
    ...
    */
    private final String getName(final BigInteger value) {
        logger.warn("AISpecStopTriggerType must convert BigInteger " + value +
